...
let pokemons = [
  ...
  },
  {
    nombre: "Charmander",
    tipo: "Fuego",
    img: "https://i.pinimg.com/originals/97/49/38/9749387b11e5a75fbb31a681f73243eb.jpg",
  },
  {
    nombre: "Pidgeotto",
    tipo: "Volador",
    img: "https://img.favpng.com/12/23/24/ash-ketchum-pok-mon-omega-ruby-and-alpha-sapphire-pidgeotto-pikachu-png-favpng-FvhcKCgEU4aLyQHnP3fa7LgRZ.jpg",
  },
];
...
function crearHTMLPokemon(pokemon) {
  ...
  listItem.classList.add("fondo-blanco");
  return listItem;
}
...
pokemons.forEach(function (pokemon) {
  ...
  const pokemonListItem = crearHTMLPokemon(pokemon);
